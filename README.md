...
=============
####简介：
[vue-calendar-js](#)是基于[vue-calendar](https://github.com/jinzhe/vue-calendar)改写的一个纯js引用的vue-component。<br/><br/>[在线例子]()
####版本：
...
####Demo code：
    ...
    <script type="text/javascript" src="caldendar.js"></script>
